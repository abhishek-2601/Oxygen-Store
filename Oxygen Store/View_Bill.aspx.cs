...
namespace Oxygen_Store
{
    public partial class View_Bill : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            BalanceCheck.ServiceClient obj = new BalanceCheck.ServiceClient();
            ...
            if (_acBal > _grandTotal)
            {
                ...
                if (_orderCount != 0)
                {
                    ...
                    for (int ab = 1; ab <= _orderCount; ab++)
                    {
                        ...
                        while (dr.Read())
                        {
                          if (Session["Stock"] == null)
                            ...
                            {
                                pro_qty = Convert.ToInt32(Session["Stock"]);
                    ...
                    int newStock = Convert.ToInt32(Session["Stock"]);
                    string sup = "update Product set Product_Stock = " + newStock + " where Product_id=" + pro_id + "";
