...
namespace Oxygen_Store
{
    public partial class View_Feedback : System.Web.UI.Page
    {
        ...
        {
            string s = "select t1.*,t2.* from Feedback t1 join users t2 on t1.User_id=t2.User_id where Status ='Pending'";
        ...
        protected void LinkButton1_Command(object sender, CommandEventArgs e)
        {
            ...
            Session["fid"] = i;
            string f = "select t1.*,t2.* from Feedback t1 join users t2 on t1.User_id = t2.User_id where fb_id='" + i + "'";
        ...
        {
            SendEmail2("Abhishek", "abhishekmaarar666@gmail.com", "lztk eyts rkdr oxdp", "'" + Label15.Text + "'", " " + Label17.Text + " ", "'" + Label16.Text + "'", "'" + TextBox1.Text + "'");
